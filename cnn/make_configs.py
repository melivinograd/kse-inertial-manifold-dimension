...
# Nx, T and N_train are taken from the parameter table in the README.
CASES = {
    (22,  0.01): (512,  2000.0, 100,  90),
    (22,  0.1):  (256,  1100.0, 100,  30),
    (22,  1.0):  (256,  1000.0, 100,   8),
    (44,  0.01): (1024, 1000.0, 100, 180),
    (44,  0.1):  (256,  1100.0, 100,  60),
    (44,  1.0):  (256,  1100.0, 100,  19),
    (66,  0.01): (1024, 1000.0, 100, 280),
    (66,  0.1):  (256,  1100.0, 100,  85),
    (66,  1.0):  (256,  1000.0, 100,  26),
